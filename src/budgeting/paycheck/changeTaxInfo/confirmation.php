...
class Confirmation extends Base
{
  ...
  {
    $sql = $this->getLink()->prepare("SELECT * FROM payrollTaxes WHERE payrollTax_id=?");
    $sql->bind_param("i", $id);
    ...
    <div class="row actionButtons">
      ...
      <a class="delete" href="deleteTax.php?id=' . $id . '">Yes</a>
    </div>';
...
$confirmation->setTitle("Ephraim Becker - Budgeting - Taxes - Delete?");
$confirmation->setLocalStyleSheet('css/style.css');
$confirmation->setLocalScript(NULL);
$confirmation->setHeader('Budgeting - Taxes - Delete?');
