...
class PrivacyPolicy extends Base
{
  ...
  {
    $html = '<p>Your privacy is important to us. It is Ephraim Becker&#39;s policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="https://ephraimbecker.com">https://ephraimbecker.com</a>, and other sites we own and operate. </p>
    <p>This policy is effective as of 24 May 2022 and was last updated on 24 May 2022. </p>';

    return $html;
  }

  function informationWeCollect(): string
  {
    $html = '
  ...
  function useOfInformation(): string
  {
    $html = '<h4>Collection and Use of Information</h4>
  ...
  function securityOfPersonalInformation(): string
  {
    $html = '<h4>Security of Your Personal Information</h4>
  ...
  function childrensPrivacy(): string
  {
    $html = '<h3>Children’s Privacy</h3>
  ...
  {
    $html = '<h3>Disclosure of Personal Information to Third Parties</h3>
  ...
  function internationalTransfers(): string
  {
    $html = '<h3>International Transfers of Personal Information</h3>
  ...
  function yourRights(): string
  {
    $html = '<h3>Your Rights and Controlling Your Personal Information</h3>
  ...
  function limitsOfPolicy(): string
  {
    $html = '<h3>Limits of Our Policy</h3>
    <p>Our website may link to external sites that are not operated by us. Please be aware that we have no control over the content and policies of those sites, and cannot accept responsibility or liability for their respective privacy practices. </p>';

    return $html;
  }

  function changesToPolicy(): string
  {
    $html = '<h3>Changes to This Policy</h3>
  ...
  {
    $html = '<div class="privacyPolicyWrapper">';
    $html .= $this->policyDescription();
    $html .= $this->informationWeCollect();
    $html .= $this->logData();
    $html .= $this->useOfInformation();
    $html .= $this->securityOfPersonalInformation();
    $html .= $this->childrensPrivacy();
    $html .= $this->disclosure();
    $html .= $this->internationalTransfers();
    $html .= $this->yourRights();
    $html .= $this->limitsOfPolicy();
    $html .= $this->changesToPolicy();
    $html .= $this->contactUs();
    $html .= '</div>';
...
$privacyPolicy->setTitle("Ephraim Becker - All about my autistic life - Privacy Policy");
$privacyPolicy->setLocalStyleSheet(NULL);
$privacyPolicy->setLocalScript(NULL);
$privacyPolicy->setHeader('Privacy Policy');
$privacyPolicy->setUrl('/privacy-policy/');
$privacyPolicy->setBody($privacyPolicy->main());
