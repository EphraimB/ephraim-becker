  ...
  <body>
    ...
    <main>
      <div itemscope itemtype="https://schema.org/Event">
        ...
        <div style="background-color: lightgrey;">
          <h2><time itemprop="startDate" datetime="2016-09-01">September 2016</time>-<time itemprop="endDate" datetime="2017-01-01">January 2017</time></h2>
          <h3 itemprop="name">More priviliges</h3>
          <p itemprop="description">Got my first phone, bank account, and went to a low-functioning drama class (which pretty much did nothing for me).</p>
        </div>
        <div style="background-color: lightgrey;">
